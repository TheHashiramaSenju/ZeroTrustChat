  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (errorData?.error?.code === 'EMAIL_NOT_VERIFIED') {
        ...
        setTimeout(() => {
          navigate('/verify-email', { state: { email: errorData.error.email || email } });
        }, 1500);
      } else {
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2 text-white">Access Control</h1>
          <p className="text-slate-400 text-sm">ZEROTRUST AUTHENTICATION</p>
        </div>
        ...
        <div className="border border-slate-800 bg-slate-900/50 p-8">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-green-600 hover:bg-green-500 text-white py-3 font-semibold transition-all disabled:opacity-50"
            >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 border border-slate-700 hover:border-slate-600 hover:bg-slate-800/50 text-white transition-all"
          >
          ...
          <div className="mt-6 text-center">
            <Link to="/register" className="text-sm text-slate-400 hover:text-green-500">
