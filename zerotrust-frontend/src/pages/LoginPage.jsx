  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (result.mfaRequired) {
        toast('2FA verification required');
        navigate('/mfa-verify', { 
          state: { 
      ...
      <div className="w-full max-w-md">
        ...
        <div className="border border-slate-800 bg-slate-900/50 p-8 backdrop-blur">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs mono">
          ...
          <button
            ...
            className="w-full py-3 border border-slate-700 hover:border-green-500 transition-all duration-300 mono text-sm flex items-center justify-center gap-3 text-slate-300 hover:text-green-500"
          >
